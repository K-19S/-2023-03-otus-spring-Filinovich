...
public class BookCommentServiceImpl implements BookCommentService {
    ...
    @Override
    @Transactional(readOnly = true)
    public String getAllCommentsDescriptionWithIdByBookId(Long id) {
    ...
    public BookComment createComment() {
        ...
        return bookCommentRepository.create(newComment);
    }
    ...
    public BookComment updateComment() {
        ...
        return bookCommentRepository.update(comment);
    }
